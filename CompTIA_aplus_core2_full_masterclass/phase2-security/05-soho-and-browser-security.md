...
**Exam trap:** "A user says incognito mode makes them anonymous online." → False — private browsing only prevents *local* history/cookie storage; the ISP, network admin, and visited sites can still see/log activity.
